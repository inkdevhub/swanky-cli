...
running command...
$ swanky (--version|-V|-v)
@astar-network/swanky-cli/1.0.8 darwin-x64 node-v18.2.0
$ swanky --help [COMMAND]
USAGE
  $ swanky COMMAND
...
...
_See code: [dist/commands/check/index.ts](https://github.com/AstarNetwork/swanky-cli/blob/v1.0.8/dist/commands/check/index.ts)_
...
_See code: [dist/commands/init/index.ts](https://github.com/AstarNetwork/swanky-cli/blob/v1.0.8/dist/commands/init/index.ts)_
