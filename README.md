...
running command...
$ swanky (--version|-V|-v)
@astar-network/swanky-cli/0.1.2 darwin-arm64 node-v18.10.0
$ swanky --help [COMMAND]
USAGE
  $ swanky COMMAND
...
...
```
USAGE
  $ swanky contract new [CONTRACTNAME] [--template contracts] [-v]
...
FLAGS
  -v, --verbose
  --template=<option>  <options: contracts>
...
```
USAGE
  $ swanky init [PROJECTNAME] [--swanky-node] [--template contracts] [-v]
