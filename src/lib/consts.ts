...
export const DEFAULT_RUST_DEP_VERSION = "1.73.0";
export const DEFAULT_RUST_NIGHTLY_DEP_VERSION = "nightly-2023-03-05";
export const DEFAULT_CARGO_DYLINT_DEP_VERSION = "2.1.11";
export const DEFAULT_CARGO_CONTRACT_DEP_VERSION = "4.0.0-alpha";
